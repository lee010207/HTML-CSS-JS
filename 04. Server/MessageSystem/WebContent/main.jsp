...
<html>
	...
	<body>
		<%
		// 로그인한 사람의 정보 가져오기
			// 모든 클래스는 Odject를 상속받고 있음 --> setAttribute()하면 어떤 타입이든 업캐스팅돼서 object형태로 저장됨
			// --> 내가 원하는 형태로 다운캐스팅해서 원하는 데이터 타입으로 담아줄 수 있음
							...
							<section id="two">
								<div class="inner">
									...
									<ul class="actions">
										<%if(info != null){ %>
											<%
												...
												for(int i =0; i<list.size(); i++){ 
													...
													out.print(list.get(i).getContent() + " (" + list.get(i).getSend_date()+ ") ");
													
													out.print("<a href='DeleteMsg.do?num=");
										...
										<li><a href="DeleteAll.do" class="button next scrolly">전체삭제하기</a></li>
